							...
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<p><br/></p>
										<a href="forgetpasswordindex.php" style="color:white; list-style:none;">Forgot Password</a><br><br>

						                <input type="submit" class="btn btn-success" style="float:right;">
										<a href="customer_registration.php?register=1"  style="color:Yellow; list-style:none;">Dont have account.?</br>Click here to Sign up</a>
