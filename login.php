		...
		else
{
	...
	//if user record is available in database then $count will be equal to 1
	if($count >= 1){
		echo "<span style='color:red;'>Wrong password..!</br> Please try again with the correct password</br> (or) To know your password click on Forgot Password</span>";
		exit();
	}
		else
		{
			echo "<span style='color:red;'>Email not registered. Please Sign Up..!</span>";
			exit();
		}
}
