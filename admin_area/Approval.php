...
use PHPMailer\PHPMailer\Exception;
	...
	$admin_email = $_GET['Approval'];
	
	 $update_status = "update admins set Confirm='Approved' where admin_email='$admin_email'";
...
try {
  ...
  $mail->isHTML(true);                               // Set email format to HTML
    $mail->Subject =  'JAIKISAN- Admin Status Change-Approved';
    $mail->Body    = ' Hello '.$admin_email.'. Your account got Approved, You can now able to access your login in Jaikisan Admin portal. Thank you !!';
 ...
 if($update_pro){
		 ...
		 echo "<script>alert('Admin has been Approved')</script>";
